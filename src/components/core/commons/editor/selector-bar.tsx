...
export const SelectorBar = ({ activeEditor }: SelectorBarProps) => {
  ...
  return (
    <div className="flex flex-row items-center gap-x-2 rounded-xl border bg-white px-4 py-2 shadow-xl">
      <Button
        onClick={() => activeEditor.chain().focus().undo().run()}
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('undo') && 'bg-gray-100')}
      >
      ...
      <Button
        ...
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('redo') && 'bg-gray-100')}
      >
      ...
      <Button
        ...
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('bold') && 'bg-gray-100')}
      >
        <IconBold size={18} />
      </Button>
      <Button
        ...
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('italic') && 'bg-gray-100')}
      >
        <IconItalic size={18} />
      </Button>
      <Button
        ...
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('underline') && 'bg-gray-100')}
      >
      ...
      <Button
        ...
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('strike') && 'bg-gray-100')}
      >
      ...
      <Button
        ...
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('subscript') && 'bg-gray-100')}
      >
      ...
      <Button
        ...
        variant={'ghost'}
        size={'icon'}
        className={cn('rounded-full', isActive('superscript') && 'bg-gray-100')}
      >
      ...
      <Button
        ...
        className={cn(
          'rounded-full',
          activeEditor.isActive({ textAlign: 'left' }) && 'bg-gray-100'
        )}
      >
      ...
      <Button
        ...
        className={cn(
          'rounded-full',
          activeEditor.isActive({ textAlign: 'center' }) && 'bg-gray-100'
        )}
      >
      ...
      <Button
        ...
        className={cn(
          'rounded-full',
          activeEditor.isActive({ textAlign: 'right' }) && 'bg-gray-100'
        )}
      >
      ...
      <Button
        ...
        className={cn(
          'rounded-full',
          activeEditor.isActive({ textAlign: 'justify' }) && 'bg-gray-100'
        )}
      >
